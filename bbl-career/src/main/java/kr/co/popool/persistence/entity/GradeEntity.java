...
public class GradeEntity extends BaseEntity {
    ...
    @Builder
    public GradeEntity(List<ScoreEntity> scores,
                       double attendanceAvg,
                       double sincerityAvg,
                       double positivenessAvg,
    ...
    public static GradeEntity toGradeEntity(List<ScoreEntity> scoreList,
    ...
    public void updateGrade(List<ScoreEntity> scoreList,
